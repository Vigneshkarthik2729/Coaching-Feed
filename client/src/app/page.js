      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        {error && !loading && (
          <div className="flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl p-4">
            ...
            <div>
              ...
              <p className="text-xs text-red-500 mt-0.5 mb-3">Check your connection and try again.</p>
              <button
                onClick={fetchFeeds}
        ...
        {!loading && !error && feeds.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-xs text-gray-400 mt-1">New sessions will appear here in real time.</p>
          </div>
        )}
